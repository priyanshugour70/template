...
import { useUpdateMyTenant } from "@/hooks/tenant/useTenantQueries";
import {
...
import { useMyTenant } from "@/hooks/tenant/useTenantQueries";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Profile, security, preferences, integrations.
        </p>
      </div>
      ...
      <Tabs defaultValue="profile" className="w-full">
        ...
        <TabsContent value="profile">
          {user ? <ProfileTab /> : <Skeleton className="h-48 w-full" />}
        </TabsContent>
        ...
        <TabsContent value="preferences">
          {user ? <PreferencesTab /> : <Skeleton className="h-48 w-full" />}
        </TabsContent>
        ...
        <CardContent>
          ...
          >
            ...
            <Field label="New password">
              ...
              />
              {tooShort && (
                <p className="text-xs text-warning">Use at least 8 characters.</p>
              )}
            </Field>
          ...
          <Button
            ...
            onClick={() =>
              create.mutate(
                {
                  name,
                  rateLimitRpm: rateLimit ? parseInt(rateLimit, 10) : undefined,
                },
                {
...
function TenantTab() {
  ...
  // One-shot hydration once tenant data arrives.
  if (tenant && !hydrated) {
    setName(tenant.name ?? "");
